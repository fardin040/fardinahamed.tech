...
experience:
  - title: Network Packet Analysis & Traffic Inspection Lab
    tag: Networking
    description: Deep-dive packet capture using Wireshark to analyze TCP 3-way handshakes, DNS queries, and HTTP/HTTPS headers for protocol security audits.
  - title: Cybersecurity Vulnerability & Reconnaissance Labs
    tag: Security
    description: Practical threat modeling, port scanning via Nmap, CTF challenges, and TryHackMe security writeups focused on web and network defense.
  - title: Embedded Microcontroller Systems
    tag: Hardware / IoT
    description: Engineered sensor systems using Arduino C++, UART/SPI communications, and real-time hardware telemetry monitors.
---
